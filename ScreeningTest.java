...
class ScreeningTest {
    ...
    // Dummy fuzzify function to replace missing FuzzyLogic class
    ...
    static double[] askQuestions(String[] questions, Scanner scanner) {
        ...
        for (int i = 0; i < questions.length; i++) {
            ...
            inputs[i] = fuzzify(response); // Use our replacement for FuzzyLogic.fuzzify()
        }
        return inputs;
    }
    ...
    public static void main(String[] args) {
       ...
       // System.out.println("Thanksgit push -u origin main\n");
